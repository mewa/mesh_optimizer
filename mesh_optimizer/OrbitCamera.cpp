...
OrbitCamera::OrbitCamera()
{
	...
	mProjectionMatrix = glm::perspective(glm::radians(90.0f), 1.0f, 0.1f, 200.0f); //Wylicz macierz rzutowania
...
void OrbitCamera::update(double x, double y)
{
	...
	mProjectionMatrix = glm::perspective(glm::radians(90.0f), 1.0f, 0.1f, 200.0f);
}
